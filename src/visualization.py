...
def draw_rocket(ax, x, y, theta, delta, throttle, trail_x, trail_y, vw=20.0, vh=24.0, title="MPC mission"):
    ax.clear()
    _style_ax(ax)
    ...
    ax.fill_between([x - 500, x + 500], -100, 0.0, color=PALETTE["ground"], alpha=0.6, zorder=0)
